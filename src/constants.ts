...
export const PROJECTS: Project[] = [
  ...
  },
  {
    id: 'automate',
    title: 'Automate',
    description: 'a simple wayland autoclicker for linux, made using Python, and gtk4/libadwaita',
  ...
  },
  {
    ...
    description: 'a pixel-accurate gemini boot animation for Linux, also optimized for speed-demon machines.',
  ...
  },
  {
    id: 'rust-projects',
    title: 'Rust projects',
    description: 'my collection of low level tools made for speed and reliability, you can find various projects on my GitHub!',
...
export const TRACKER_ITEMS: TrackerItem[] = [
  {
    ...
    title: 'ceh cert',
    category: 'security',
    tips: ['understand the methodology, not just the tool', 'network layer basics are everything'],
  ...
  },
  {
    ...
    category: 'Design',
    tips: ['squircles are superior geometry', 'animations should feel organic and not static'],
  ...
  },
  {
    ...
    title: 'research',
    category: 'security',
    tips: ['documentation is 50% of the exploit', 'keep the environment isolated'],
