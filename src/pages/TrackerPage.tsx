    ...
    <div className="max-w-6xl mx-auto space-y-16">
      <header className="page-header flex flex-col md:flex-row md:items-end justify-between gap-6 px-4 md:px-0">
        <div className="space-y-4">
          <h2 className="page-title !text-7xl md:!text-9xl font-expressive-bold italic">Tracker</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 md:px-0">
        {TRACKER_ITEMS.map((item, i) => (
          <Card
            key={item.id}
            delay={i * 0.1}
            innerClassName="p-10 md:p-12 border-6 border-[var(--outline-variant)]/40 hover:border-[var(--primary)] transition-colors flex flex-col justify-between min-h-[450px] group/tracker"
          >
